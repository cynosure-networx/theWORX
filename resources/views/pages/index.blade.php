...
@section('bodyClasses', 'antialiased')
@section('bodyStyles', '')
        ...
        <div class="swiper swiper-parent">
            <div class="swiper-wrapper">
                <div class="swiper-slide dark">
                    <div class="container">
                        <div class="slider-caption slider-caption-center">
                            <h2 data-animate="fadeInUp">Welcome to theWORX 2.0</h2>
                    ...
                    <div class="swiper-slide-bg" style="background-image: url('images/template/slider/swiper/1.jpg');"></div>
                </div>
                <div class="swiper-slide dark">
                    <div class="container">
                        <div class="slider-caption slider-caption-center">
                    ...
                    <div class="video-wrap no-placeholder">
                        <video id="slide-video" poster="images/template/videos/explore-poster.jpg" preload="auto" loop autoplay muted playsinline>
                            <source src='images/template/videos/explore.webm' type='video/webm'>
                            <source src='images/template/videos/explore.mp4' type='video/mp4'>
                        </video>
                ...
                <div class="swiper-slide">
                    ...
                    <div class="swiper-slide-bg" style="background-image: url('images/template/slider/swiper/3.jpg'); background-position: center top;"></div>
                </div>
            </div>
...
<section id="content">
    <div class="content-wrap">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 align-self-end">
                    ...
                    <div class="position-relative overflow-hidden">
                        <img src="images/template/services/main-fbrowser.png" data-animate="fadeInUp" data-delay="100" alt="Chrome">
                        <img src="images/template/services/main-fmobile.png" style="top: 0; left: 0; min-width: 100%; min-height: 100%;" data-animate="fadeInUp" data-delay="400" alt="iPhone" class="position-absolute">
                    </div>
        ...
        <div class="container">
            ...
            <div class="row align-items-center col-mb-50 mb-4">
                ...
                <div class="col-lg-4 d-md-none d-lg-block text-center">
                    <img src="images/template/services/iphone7.png" alt="iphone 2">
                </div>
        ...
        <div class="row align-items-stretch">
            ...
            <div class="col-lg-6 text-center col-padding" style="background: url('images/template/services/main-bg.jpg') center center no-repeat; background-size: cover;">
            </div>
            ...
            <div class="col-lg-6 text-center col-padding bg-contrast-100">
                ...
                <div class="text-center mb-5">
                    <a class="d-block position-relative" href="https://vimeo.com/101373765" data-lightbox="iframe">
                        <img src="images/template/services/video.jpg" alt="Video">
        ...
        <div id="portfolio" class="portfolio row g-0 portfolio-reveal">
                ...
                <div class="grid-inner">
                    <div class="portfolio-image">
                        <a href="portfolio-single.html">
                            <img src="images/template/portfolio/4/1.jpg" alt="Open Imagination">
                        </a>
                        <div class="bg-overlay">
                            <div class="bg-overlay-content dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item">
                                <a href="images/template/portfolio/full/1.jpg" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-hover-parent=".portfolio-item" data-lightbox="image" title="Image"><i class="uil uil-plus"></i></a>
            ...
            <article class="portfolio-item col-6 col-md-4 col-lg-3 pf-illustrations">
                <div class="grid-inner">
                    <div class="portfolio-image">
                        <a href="portfolio-single.html">
                            <img src="images/template/portfolio/4/2.jpg" alt="Locked Steel Gate">
                        </a>
                        <div class="bg-overlay">
                            <div class="bg-overlay-content dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item">
                                <a href="images/template/portfolio/full/2.jpg" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-hover-parent=".portfolio-item" data-lightbox="image" title="Image"><i class="uil uil-plus"></i></a>
                                <a href="portfolio-single.html" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-hover-parent=".portfolio-item"><i class="uil uil-ellipsis-h"></i></a>
                            </div>
                            <div class="bg-overlay-bg dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item"></div>
                        </div>
            ...
            <article class="portfolio-item col-6 col-md-4 col-lg-3 pf-graphics pf-uielements">
                <div class="grid-inner">
                    <div class="portfolio-image">
                        <a href="#">
                            <img src="images/template/portfolio/4/3.jpg" alt="Mac Sunglasses">
                        </a>
                        <div class="bg-overlay">
                            <div class="bg-overlay-content dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item">
            ...
            <article class="portfolio-item col-6 col-md-4 col-lg-3 pf-icons pf-illustrations">
                <div class="grid-inner">
                    <div class="portfolio-image">
                        <a href="portfolio-single.html">
                            <img src="images/template/portfolio/4/4.jpg" alt="Open Imagination">
                        </a>
                        <div class="bg-overlay" data-lightbox="gallery">
                            <div class="bg-overlay-content dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item">
                                <a href="images/template/portfolio/full/4.jpg" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-hover-parent=".portfolio-item" data-lightbox="gallery-item"><i class="uil uil-images"></i></a>
                                <a href="images/template/portfolio/full/4-1.jpg" class="d-none" data-lightbox="gallery-item"></a>
                                <a href="portfolio-single.html" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-hover-parent=".portfolio-item"><i class="uil uil-ellipsis-h"></i></a>
                            </div>
                            <div class="bg-overlay-bg dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item"></div>
                        </div>
            ...
            <article class="portfolio-item col-6 col-md-4 col-lg-3 pf-uielements pf-media">
                <div class="grid-inner">
                    <div class="portfolio-image">
                        <a href="portfolio-single.html">
                            <img src="images/template/portfolio/4/5.jpg" alt="Console Activity">
                        </a>
                        <div class="bg-overlay">
                            <div class="bg-overlay-content dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item">
                                <a href="images/template/portfolio/full/5.jpg" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-hover-parent=".portfolio-item" data-lightbox="image" title="Image"><i class="uil uil-plus"></i></a>
                                <a href="portfolio-single.html" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-hover-parent=".portfolio-item"><i class="uil uil-ellipsis-h"></i></a>
                            </div>
                            <div class="bg-overlay-bg dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item"></div>
                        </div>
            ...
            <article class="portfolio-item col-6 col-md-4 col-lg-3 pf-graphics pf-illustrations">
                <div class="grid-inner">
                    <div class="portfolio-image">
                        <a href="portfolio-single.html">
                            <img src="images/template/portfolio/4/6.jpg" alt="Open Imagination">
                        </a>
                        <div class="bg-overlay" data-lightbox="gallery">
                            <div class="bg-overlay-content dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item">
                                <a href="images/template/portfolio/full/6.jpg" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-hover-parent=".portfolio-item" data-lightbox="gallery-item"><i class="uil uil-images"></i></a>
                                <a href="images/template/portfolio/full/6-1.jpg" class="d-none" data-lightbox="gallery-item"></a>
                                <a href="images/template/portfolio/full/6-2.jpg" class="d-none" data-lightbox="gallery-item"></a>
                                <a href="images/template/portfolio/full/6-3.jpg" class="d-none" data-lightbox="gallery-item"></a>
                ...
                <div class="grid-inner">
                    <div class="portfolio-image">
                        <a href="portfolio-single-video.html">
                            <img src="images/template/portfolio/4/7.jpg" alt="Backpack Contents">
                        </a>
                        <div class="bg-overlay">
                            <div class="bg-overlay-content dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item">
            ...
            <article class="portfolio-item col-6 col-md-4 col-lg-3 pf-graphics">
                <div class="grid-inner">
                    <div class="portfolio-image">
                        <a href="portfolio-single.html">
                            <img src="images/template/portfolio/4/8.jpg" alt="Sunset Bulb Glow">
                        </a>
                        <div class="bg-overlay">
                            <div class="bg-overlay-content dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item">
                                <a href="images/template/portfolio/full/8.jpg" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-hover-parent=".portfolio-item" data-lightbox="image" title="Image"><i class="uil uil-plus"></i></a>
                                <a href="portfolio-single.html" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-hover-parent=".portfolio-item"><i class="uil uil-ellipsis-h"></i></a>
                            </div>
                            <div class="bg-overlay-bg dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item"></div>
                        </div>
        ...
        <div class="container">
            ...
            <div class="row align-items-center col-mb-50">
                <div class="col-md-4 text-center">
                    <img data-animate="fadeInLeft" src="images/template/services/iphone6.png" alt="Iphone">
                </div>
        ...
        <div class="section parallax scroll-detect dark mb-0 py-6">
            <img src="images/template/services/home-testi-bg.jpg" class="parallax-bg">
                ...
                <div class="flexslider">
                    <div class="slider-wrap">
                        <div class="slide">
                            <div class="row flex-column text-center align-items-center gy-3">
                                <div class="col-auto pt-1">
                                    <img class="rounded-circle w-auto mx-auto" src="images/template/testimonials/3.jpg" width="56" height="56" alt="Customer Testimonails">
                                </div>
                                <div class="col-lg-5">
                        ...
                        <div class="slide">
                            <div class="row flex-column text-center align-items-center gy-3">
                                <div class="col-auto pt-1">
                                    <img class="rounded-circle w-auto mx-auto" src="images/template/testimonials/2.jpg" width="56" height="56" alt="Customer Testimonails">
                                </div>
                                <div class="col-lg-5">
                        ...
                        <div class="slide">
                            <div class="row flex-column text-center align-items-center gy-3">
                                <div class="col-auto pt-1">
                                    <img class="rounded-circle w-auto mx-auto" src="images/template/testimonials/1.jpg" width="56" height="56" alt="Customer Testimonails">
                                </div>
                                <div class="col-lg-5">
        ...
        <div class="container">
            <div class="row posts-md col-mb-30">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="entry">
                        <div class="entry-image">
                            <a href="#"><img src="images/template/magazine/thumb/1.jpg" alt="Image" class="rounded"></a>
                        </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="entry">
                        <div class="entry-image">
                            <a href="#"><img src="images/template/magazine/thumb/2.jpg" alt="Image" class="rounded"></a>
                        </div>
                        <div class="entry-title title-xs text-transform-none px-2">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="entry">
                        <div class="entry-image">
                            <a href="#"><img src="images/template/magazine/thumb/3.jpg" alt="Image" class="rounded"></a>
                        </div>
                        <div class="entry-title title-xs text-transform-none px-2">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="entry">
                        <div class="entry-image">
                            <a href="#"><img src="images/template/magazine/thumb/4.jpg" alt="Image" class="rounded"></a>
                        </div>
                        <div class="entry-title title-xs text-transform-none px-2">
            ...
            <div class="container">
                ...
                <div class="row g-5 mb-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="team">
                            <div class="team-image">
                                <img src="images/template/team/3.jpg" alt="John Doe">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="team">
                            <div class="team-image">
                                <img src="images/template/team/2.jpg" alt="Josh Clark">
                            </div>
                            <div class="team-desc team-desc-bg">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="team">
                            <div class="team-image">
                                <img src="images/template/team/8.jpg" alt="Mary Jane">
                            </div>
                            <div class="team-desc team-desc-bg">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="team">
                            <div class="team-image">
                                <img src="images/template/team/4.jpg" alt="Nix Maxwell">
                            </div>
                            <div class="team-desc team-desc-bg">
        ...
        <div class="container">
            <div id="oc-clients" class="owl-carousel image-carousel carousel-widget" data-margin="60" data-loop="true" data-nav="false" data-autoplay="5000" data-pagi="false" data-items-xs="2" data-items-sm="3" data-items-md="4" data-items-lg="5" data-items-xl="6">
                <div class="oc-item p-4 op-ts op-05 h-op-1"><a href="#"><img src="images/template/clients/1.png" alt="Clients"></a></div>
                <div class="oc-item p-4 op-ts op-05 h-op-1"><a href="#"><img src="images/template/clients/2.png" alt="Clients"></a></div>
                <div class="oc-item p-4 op-ts op-05 h-op-1"><a href="#"><img src="images/template/clients/3.png" alt="Clients"></a></div>
                <div class="oc-item p-4 op-ts op-05 h-op-1"><a href="#"><img src="images/template/clients/4.png" alt="Clients"></a></div>
                <div class="oc-item p-4 op-ts op-05 h-op-1"><a href="#"><img src="images/template/clients/5.png" alt="Clients"></a></div>
                <div class="oc-item p-4 op-ts op-05 h-op-1"><a href="#"><img src="images/template/clients/6.png" alt="Clients"></a></div>
                <div class="oc-item p-4 op-ts op-05 h-op-1"><a href="#"><img src="images/template/clients/7.png" alt="Clients"></a></div>
                <div class="oc-item p-4 op-ts op-05 h-op-1"><a href="#"><img src="images/template/clients/8.png" alt="Clients"></a></div>
                <div class="oc-item p-4 op-ts op-05 h-op-1"><a href="#"><img src="images/template/clients/9.png" alt="Clients"></a></div>
                <div class="oc-item p-4 op-ts op-05 h-op-1"><a href="#"><img src="images/template/clients/10.png" alt="Clients"></a></div>
            </div>
        </div>
    </div>
</section><!-- #content end -->
